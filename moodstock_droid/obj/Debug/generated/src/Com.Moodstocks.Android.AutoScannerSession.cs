...
namespace Com.Moodstocks.Android {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']"
	[global::Android.Runtime.Register ("com/moodstocks/android/AutoScannerSession", DoNotGenerateAcw=true)]
	public partial class AutoScannerSession : global::Android.OS.Handler, global::Com.Moodstocks.Android.Camera.CameraManager.IListener {

		// Metadata.xml XPath interface reference: path="/api/package[@name='com.moodstocks.android']/interface[@name='AutoScannerSession.AdvancedListener']"
		[Register ("com/moodstocks/android/AutoScannerSession$AdvancedListener", "", "Com.Moodstocks.Android.AutoScannerSession/IAdvancedListenerInvoker")]
		public partial interface IAdvancedListener : global::Com.Moodstocks.Android.AutoScannerSession.IListener {

			// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/interface[@name='AutoScannerSession.AdvancedListener']/method[@name='onResult' and count(parameter)=2 and parameter[1][@type='com.moodstocks.android.Result'] and parameter[2][@type='android.graphics.Bitmap']]"
			[Register ("onResult", "(Lcom/moodstocks/android/Result;Landroid/graphics/Bitmap;)V", "GetOnResult_Lcom_moodstocks_android_Result_Landroid_graphics_Bitmap_Handler:Com.Moodstocks.Android.AutoScannerSession/IAdvancedListenerInvoker, moodstock_droid")]
			void OnResult (global::Com.Moodstocks.Android.Result p0, global::Android.Graphics.Bitmap p1);

		}

		[global::Android.Runtime.Register ("com/moodstocks/android/AutoScannerSession$AdvancedListener", DoNotGenerateAcw=true)]
		internal class IAdvancedListenerInvoker : global::Java.Lang.Object, IAdvancedListener {

			static IntPtr java_class_ref = JNIEnv.FindClass ("com/moodstocks/android/AutoScannerSession$AdvancedListener");
			IntPtr class_ref;

			public static IAdvancedListener GetObject (IntPtr handle, JniHandleOwnership transfer)
			{
				return global::Java.Lang.Object.GetObject<IAdvancedListener> (handle, transfer);
			}
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
								JNIEnv.GetClassNameFromInstance (handle), "com.moodstocks.android.AutoScannerSession.AdvancedListener"));
				return handle;
			}
			...
			public IAdvancedListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
			{
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (IAdvancedListenerInvoker); }
			}
...
#pragma warning disable 0169
			...
			{
				global::Com.Moodstocks.Android.AutoScannerSession.IAdvancedListener __this = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.AutoScannerSession.IAdvancedListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			static Delegate cb_onResult_Lcom_moodstocks_android_Result_;
#pragma warning disable 0169
			static Delegate GetOnResult_Lcom_moodstocks_android_Result_Handler ()
			{
				if (cb_onResult_Lcom_moodstocks_android_Result_ == null)
					cb_onResult_Lcom_moodstocks_android_Result_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_OnResult_Lcom_moodstocks_android_Result_);
				return cb_onResult_Lcom_moodstocks_android_Result_;
			}

			static void n_OnResult_Lcom_moodstocks_android_Result_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
			{
				global::Com.Moodstocks.Android.AutoScannerSession.IAdvancedListener __this = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.AutoScannerSession.IAdvancedListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Com.Moodstocks.Android.Result p0 = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.Result> (native_p0, JniHandleOwnership.DoNotTransfer);
				__this.OnResult (p0);
...
#pragma warning restore 0169
			...
			IntPtr id_onResult_Lcom_moodstocks_android_Result_;
			public unsafe void OnResult (global::Com.Moodstocks.Android.Result p0)
			{
				if (id_onResult_Lcom_moodstocks_android_Result_ == IntPtr.Zero)
					id_onResult_Lcom_moodstocks_android_Result_ = JNIEnv.GetMethodID (class_ref, "onResult", "(Lcom/moodstocks/android/Result;)V");
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallVoidMethod (Handle, id_onResult_Lcom_moodstocks_android_Result_, __args);
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath interface reference: path="/api/package[@name='com.moodstocks.android']/interface[@name='AutoScannerSession.Listener']"
		[Register ("com/moodstocks/android/AutoScannerSession$Listener", "", "Com.Moodstocks.Android.AutoScannerSession/IListenerInvoker")]
		public partial interface IListener : IJavaObject {

			// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/interface[@name='AutoScannerSession.Listener']/method[@name='onCameraOpenFailed' and count(parameter)=1 and parameter[1][@type='java.lang.Exception']]"
			[Register ("onCameraOpenFailed", "(Ljava/lang/Exception;)V", "GetOnCameraOpenFailed_Ljava_lang_Exception_Handler:Com.Moodstocks.Android.AutoScannerSession/IListenerInvoker, moodstock_droid")]
			void OnCameraOpenFailed (global::Java.Lang.Exception p0);

			// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/interface[@name='AutoScannerSession.Listener']/method[@name='onResult' and count(parameter)=1 and parameter[1][@type='com.moodstocks.android.Result']]"
			[Register ("onResult", "(Lcom/moodstocks/android/Result;)V", "GetOnResult_Lcom_moodstocks_android_Result_Handler:Com.Moodstocks.Android.AutoScannerSession/IListenerInvoker, moodstock_droid")]
			void OnResult (global::Com.Moodstocks.Android.Result p0);

			// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/interface[@name='AutoScannerSession.Listener']/method[@name='onWarning' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
			[Register ("onWarning", "(Ljava/lang/String;)V", "GetOnWarning_Ljava_lang_String_Handler:Com.Moodstocks.Android.AutoScannerSession/IListenerInvoker, moodstock_droid")]
			void OnWarning (string p0);

		}

		[global::Android.Runtime.Register ("com/moodstocks/android/AutoScannerSession$Listener", DoNotGenerateAcw=true)]
		internal class IListenerInvoker : global::Java.Lang.Object, IListener {

			static IntPtr java_class_ref = JNIEnv.FindClass ("com/moodstocks/android/AutoScannerSession$Listener");
			IntPtr class_ref;
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
								JNIEnv.GetClassNameFromInstance (handle), "com.moodstocks.android.AutoScannerSession.Listener"));
				return handle;
			}
...
#pragma warning disable 0169
			...
			static void n_OnCameraOpenFailed_Ljava_lang_Exception_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
			{
				global::Com.Moodstocks.Android.AutoScannerSession.IListener __this = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.AutoScannerSession.IListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Java.Lang.Exception p0 = global::Java.Lang.Object.GetObject<global::Java.Lang.Exception> (native_p0, JniHandleOwnership.DoNotTransfer);
				__this.OnCameraOpenFailed (p0);
			}
#pragma warning restore 0169
...
#pragma warning restore 0169
		...
		public partial class ResultEventArgs : global::System.EventArgs {
			...
			public ResultEventArgs (global::Com.Moodstocks.Android.Result p0)
			{
				this.p0 = p0;
			}
		...
		[global::Android.Runtime.Register ("mono/com/moodstocks/android/AutoScannerSession_ListenerImplementor")]
		internal sealed partial class IListenerImplementor : global::Java.Lang.Object, IListener {
			...
			public IListenerImplementor (object sender)
				: base (
					global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/moodstocks/android/AutoScannerSession_ListenerImplementor", "()V"),
...
#pragma warning restore 0649
			...
			public void OnResult (global::Com.Moodstocks.Android.Result p0)
			{
...
#pragma warning restore 0649
			...
			{
				return value.OnCameraOpenFailedHandler == null && value.OnResultHandler == null && value.OnWarningHandler == null;
			}
		}


		// Metadata.xml XPath class reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession.ReturnCode']"
		[global::Android.Runtime.Register ("com/moodstocks/android/AutoScannerSession$ReturnCode", DoNotGenerateAcw=true)]
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/moodstocks/android/AutoScannerSession", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AutoScannerSession); }
		}

		protected AutoScannerSession (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_app_Activity_Lcom_moodstocks_android_Scanner_Lcom_moodstocks_android_AutoScannerSession_Listener_Landroid_view_SurfaceView_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/constructor[@name='AutoScannerSession' and count(parameter)=4 and parameter[1][@type='android.app.Activity'] and parameter[2][@type='com.moodstocks.android.Scanner'] and parameter[3][@type='com.moodstocks.android.AutoScannerSession.Listener'] and parameter[4][@type='android.view.SurfaceView']]"
		[Register (".ctor", "(Landroid/app/Activity;Lcom/moodstocks/android/Scanner;Lcom/moodstocks/android/AutoScannerSession$Listener;Landroid/view/SurfaceView;)V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Com.Moodstocks.Android.AutoScannerSession __this = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.AutoScannerSession> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsListening {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='isListening' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='onCameraOpenException' and count(parameter)=1 and parameter[1][@type='java.lang.Exception']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='onNewFrameInBackground' and count(parameter)=1 and parameter[1][@type='com.moodstocks.android.camera.CameraFrame']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='pause' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='resume' and count(parameter)=0]"
		...
		static Delegate cb_setResultExtras_I;
#pragma warning disable 0169
		static Delegate GetSetResultExtras_IHandler ()
		{
			if (cb_setResultExtras_I == null)
				cb_setResultExtras_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetResultExtras_I);
			return cb_setResultExtras_I;
		}

		static void n_SetResultExtras_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Com.Moodstocks.Android.AutoScannerSession __this = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.AutoScannerSession> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.SetResultExtras (p0);
		}
#pragma warning restore 0169

		static IntPtr id_setResultExtras_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='setResultExtras' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setResultExtras", "(I)V", "GetSetResultExtras_IHandler")]
		public virtual unsafe void SetResultExtras (int p0)
		{
			if (id_setResultExtras_I == IntPtr.Zero)
				id_setResultExtras_I = JNIEnv.GetMethodID (class_ref, "setResultExtras", "(I)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setResultExtras_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setResultExtras", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='setResultTypes' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		static Delegate cb_setSearchOptions_I;
#pragma warning disable 0169
		static Delegate GetSetSearchOptions_IHandler ()
		{
			if (cb_setSearchOptions_I == null)
				cb_setSearchOptions_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetSearchOptions_I);
			return cb_setSearchOptions_I;
		}

		static void n_SetSearchOptions_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Com.Moodstocks.Android.AutoScannerSession __this = global::Java.Lang.Object.GetObject<global::Com.Moodstocks.Android.AutoScannerSession> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.SetSearchOptions (p0);
		}
#pragma warning restore 0169

		static IntPtr id_setSearchOptions_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='setSearchOptions' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setSearchOptions", "(I)V", "GetSetSearchOptions_IHandler")]
		public virtual unsafe void SetSearchOptions (int p0)
		{
			if (id_setSearchOptions_I == IntPtr.Zero)
				id_setSearchOptions_I = JNIEnv.GetMethodID (class_ref, "setSearchOptions", "(I)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setSearchOptions_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setSearchOptions", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='start' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.moodstocks.android']/class[@name='AutoScannerSession']/method[@name='stop' and count(parameter)=0]"
